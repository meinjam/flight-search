...
const DepartureDetailsHead = ({ headBg, leftText, rightText }: DepartureDetailsHeadType) => {
  return (
    <div className='flex items-center gap-3 my-[2px]'>
      <div className='w-8 h-9 grid place-content-center shrink-0'>
        <LocationSvg />
      </div>
      <div className={`bg-[${headBg}] grow text-theme-13 flex justify-between items-center rounded-md px-4 py-3`}>
